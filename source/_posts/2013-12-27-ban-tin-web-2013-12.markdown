...
- [parse5: An HTML5 Parser for Node.js](https://github.com/inikulin/parse5) — A
  fast, full-featured HTML parser for Node, based on the WHATWG HTML5 specification.
...
- [Zephir Language](http://zephir-lang.com/) Ngôn ngữ trung gian giúp lập trình
  viên PHP có thể viết PHP Extension không cần rành C #php #zephir
...
- [Propilex](https://github.com/willdurand/Propilex) , tên nghe lạ, nhưng là
  framework tập hợp các anh hào rất quen — Silex, Propel, Backbone, Stack,
  Hateoas, Negotiation, and so on… Services ready, rất thú vị #php #framework
  #silex #propel #backbone
- [opcache](http://php.net/opcache) đã được đưa vào PHP 5.5. Quên APC lần lần nhé
  anh em #php #php55 #opcache
- [gitlist](https://github.com/klaussilveira/gitlist) Ứng dụng viết bằng PHP giúp
  đọc git repos #php #app #git #reader
- [WordPress 3.8 Has Been Released](http://speckyboy.com/2013/12/14/wordpress-3-8-released-week/)

### Drupal

- [DrupalAppConsole](https://github.com/hechoendrupal/DrupalAppConsole) — The
  Symfony Console for Drupal
- [Mánh nhỏ](http://cafuego.net/2013/04/26/add-images-drupal-your-mobile-device)
  giúp image field lấy ảnh được từ camera #drupal #dev #mobile #tip
- [Một số site nổi tiếng](https://www.facebook.com/laptrinhviendrupal/posts/726549914022039)
  của Việt Nam sử dụng Drupal #drupal #sites
- Như đã biết, APC thuần tuý đã không còn cần thiết ở PHP 5.5. Anh em nào còn
  sử dụng tính năng user cache của APC, có thể sử dụng
  [extension APCu](http://pecl.php.net/package/APCu) #php #php55 #apc #apcu
